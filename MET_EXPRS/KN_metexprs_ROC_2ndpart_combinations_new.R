...
png("metexprs_roc_combinations_OVCa_output20260121.png", 
...
gtsave(gt_table,
       filename = "metexprs_table_combinations_OVCa_output20260121.png",
       vwidth = 600)

#save images together
roc_image2   <- image_read("metexprs_roc_combinations_OVCa_output20260121.png")
table_image2 <- image_read("metexprs_table_combinations_OVCa_output20260121.png")
...
#there is no other convieneat way to save gt outputs
gtsave(gt_tableEN,
       filename = "metexprs_table_combinations_OVCa_outputEN20260121.png",
       vwidth = 500)
...
# Save the plot as a PNG file
png("metexprs_roc_HGSOC_output20260121.png",
    width = 15, height = 15, res = 510, units = "cm")
roc_plot_4()
dev.off()
...
gtsave(gt_table2,vwidth = 600,
       filename = "metexprs_table_HGSOC_output20260121.png")

#Combine the images
#save images together
roc_image2   <- image_read("metexprs_roc_HGSOC_output20260121.png")
table_image2 <- image_read("metexprs_table_HGSOC_output20260121.png")
...
# Save the plot as a PNG file
png("metexprs_roc_HGSOC_outputEN20260121.png",
    width = 15, height = 15, res = 510, units = "cm")
roc_plot_4EN()
dev.off()
...
gtsave(gt_table2EN,vwidth = 500, 
       filename = "metexprs_table_HGSOC_outputEN20260121.png")


# Save the combined image
roc_image2   <- image_read("metexprs_roc_HGSOC_outputEN20260121.png")
table_image2 <- image_read("metexprs_table_HGSOC_outputEN20260121.png")
...
# Save the plot as a PNG file
png("metexprs_roc_HGSOC_OTHERS_MODELS_output20260121.png",
    width = 15, height = 15, res = 510, units = "cm")
roc_plot_5()
dev.off()
...
gtsave(gt_tablex,vwidth = 600,
       filename = "metexprs_table_HGSOC_OTHERS_MODELS_output20260121.png")

# Save the combined image
roc_image2   <- image_read("metexprs_roc_HGSOC_OTHERS_MODELS_output20260121.png")
table_image2 <- image_read("metexprs_table_HGSOC_OTHERS_MODELS_output20260121.png")
...
# Save the plot as a PNG file
png("metexprs_roc_HGSOC_OTHERS_MODELS_outputEN20260121.png",
    width = 15, height = 15, res = 510, units = "cm")
roc_plot_5EN()
dev.off()
...
gtsave(gt_tablexEN,vwidth = 500,
       filename = "metexprs_table_HGSOC_OTHERS_MODELS_outputEN20260121.png")


# Save the combined image
roc_image2   <- image_read("metexprs_roc_HGSOC_OTHERS_MODELS_outputEN20260121.png")
table_image2 <- image_read("metexprs_table_HGSOC_OTHERS_MODELS_outputEN20260121.png")
