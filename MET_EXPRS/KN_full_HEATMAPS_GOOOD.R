...
png("C:/Users/Ieva/rprojects/outputs_all/DISS/heatmap_output_METHILATION20260130.png",
    width = 15, height = 24,
    res = 400, units = "cm", pointsize = 12) # width and height in pixels, resolution in dpi
