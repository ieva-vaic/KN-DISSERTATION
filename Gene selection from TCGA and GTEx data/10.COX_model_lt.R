...
#get best genes to predict overall survival in TCGA-OV (ovarian cancer)
# Load packages ##########################################
Sys.setenv(LANG = "en")
library(glmnet)
library(tidyverse)
...
#save plot
png("C:/Users/Ieva/rprojects/outputs_all/DISS/cv_plot.png", width =600, height = 550) 
plot(cvfit)# Render 
